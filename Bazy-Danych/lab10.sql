...
-- zródlem problemu jest ten sam pseudonim Wawezyn2
...
select nr_akt,nazwisko,id_dzialu,stanowisko,placa+
nvl(dod_funkcyjny,0)+dod_staz*placa*0.01-nvl(koszt_ubezpieczenia,0) pensja
